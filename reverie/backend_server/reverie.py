...
log_file = os.path.join(base_folder, "reverie/logs/simulacra.log")
logging.basicConfig(
    filename=log_file, level=logging.DEBUG, format="%(asctime)s - %(name)s: %(message)s"
)
...
class ReverieServer:
    ...
    def save(self):
        ...
        """
        if debug:
            logger.info("[INFO]: <reverie.py> <save> Saving all progress...")
    ...
    def start_path_tester_server(self):
        ...
        if debug:
            logger.info(
                "[INFO]: <reverie.py> <start_path_tester_server> Starting path tester server..."
            )
    ...
    def start_server(self, int_counter):
        ...
        """
        if debug:
            logger.info("[INFO]: <reverie.py> <start_server> Starting server...")
        # <sim_folder> points to the current simulation folder.
        sim_folder = f"{fs_storage}/{self.sim_code}"
        ...
        while True:
            ...
            if debug:
                logger.info(f"[INFO]: -----------------------------")
                logger.info(f"[INFO]: ------Start Step {self.step}------")
                logger.info(f"[INFO]: -----------------------------")
            ...
            if check_if_file_exists(curr_env_file):
                ...
                if env_retrieved:
                    ...
                    if debug:
                        logger.info(f"[INFO]: Cleaning game objects")
                        logger.info(f"[INFO]: -----------------------------")
                    ...
                    if debug:
                        logger.info(f"[INFO]: Going through each persona")
                        logger.info(f"[INFO]: -----------------------------")
                    for persona_name, persona in self.personas.items():
                        ...
                        if debug:
                            logger.info(
                                f"[INFO]: Where {persona_name} was at before: {curr_tile}"
                            )
                        ...
                        if debug:
                            logger.info(
                                f"[INFO]: Where {persona_name} is moving to {new_tile}"
                            )
                        ...
                        if debug:
                            logger.info(
                                f"[INFO]: {persona_name} moved from {curr_tile} to {new_tile}"
                            )
                            logger.info(f"[INFO]: -----------------------------")
                        ...
                        if not persona.scratch.planned_path:
                            ...
                            if debug:
                                logger.info(
                                    f"[INFO]: {persona_name} is doing {persona.scratch.get_curr_obj_event_and_desc()}"
                                )
                                logger.info(f"[INFO]: -----------------------------")
                    ...
                    for persona_name, persona in self.personas.items():
                        ...
                        if debug:
                            logger.info(
                                f"[INFO]: {persona_name} is moving to {next_tile}"
                            )
                            logger.info(
                                f"[INFO]: {persona_name} is doing {pronunciatio}"
                            )
                            logger.info(
                                f"[INFO]: {persona_name} is doing {description}"
                            )
                            logger.info(f"[INFO]: -----------------------------")
                    ...
                    if debug:
                        logger.info(f"[INFO]: -----------------------------")
                        logger.info(f"[INFO]: Making movements {movements}")
                        logger.info(f"[INFO]: -----------------------------")
                    ...
                    if debug:
                        logger.info(f"[INFO]: -----------------------------")
                        logger.info(f"[INFO]: ---------End Step {self.step}---------")
                        logger.info(f"[INFO]: -----------------------------")
