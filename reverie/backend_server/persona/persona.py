...
class Persona:
    def __init__(self, name, folder_mem_saved=False):
        ...
        if debug:
            logger.info(f"[INFO]: {self.name} is created.")
    ...
    def save(self, save_folder):
        ...
        """
        if debug:
            logger.info(f"[INFO]: Saving {self.name}'s state to {save_folder}.")
    ...
    def perceive(self, maze):
        ...
        """
        if debug:
            logger.info(f"[INFO]: {self.name} is perceiving.")
    ...
    def retrieve(self, perceived):
        ...
        """
        if debug:
            logger.info(f"[INFO]: {self.name} is retrieving.")
    ...
    def plan(self, maze, personas, new_day, retrieved):
        ...
        """
        if debug:
            logger.info(f"[INFO]: {self.name} is planning.")
    ...
    def execute(self, maze, personas, plan):
        ...
        """
        if debug:
            logger.info(f"[INFO]: {self.name} is executing.")
    ...
    def reflect(self):
        ...
        """
        if debug:
            logger.info(f"[INFO]: {self.name} is reflecting.")
        reflect(self)
    ...
    def move(self, maze, personas, curr_tile, curr_time):
        ...
        """
        if debug:
            logger.info(f"[INFO]: {self.name} is moving.")
    ...
    def open_convo_session(self, convo_mode):
        if debug:
            logger.info(f"[INFO]: {self.name} is opening a conversation session.")
