...
class MemoryTree:
    def __init__(self, f_saved):
        if debug:
            logger.info("[INFO]: [MemoryTree] Initializing MemoryTree.")
        self.tree = {}
    ...
    def print_tree(self):
        if debug:
            logger.info("[INFO]: [MemoryTree] Printing MemoryTree.")
    ...
    def save(self, out_json):
        if debug:
            logger.info("[INFO]: [MemoryTree] Saving MemoryTree.")
    ...
    def get_str_accessible_sectors(self, curr_world):
        ...
        """
        if debug:
            logger.info("[INFO]: [MemoryTree] Getting accessible sectors.")
    ...
    def get_str_accessible_sector_arenas(self, sector):
        ...
        """
        if debug:
            logger.info("[INFO]: [MemoryTree] Getting accessible sector arenas.")
    ...
    def get_str_accessible_arena_game_objects(self, arena):
        ...
        """
        if debug:
            logger.info("[INFO]: [MemoryTree] Getting accessible arena game objects.")
